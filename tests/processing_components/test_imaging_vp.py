...
class TestImagingVP(unittest.TestCase):
    ...
    def actualSetUp(self, zerow=True, block=False, image_pol=PolarisationFrame("stokesIQUV"), npixel=None, rmax=750.0,
        ...
        self.gcf, self.cf = create_awterm_convolutionfunction(self.model, make_pb=make_vp,
                                                              oversampling=2, maxsupport=512,
    ...
    def _checkcomponents(self, dirty, fluxthreshold=0.6, positionthreshold=0.1):
        ...
        for comp in comps:
            ...
            assert separation / self.cellsize < positionthreshold, "Component differs in position %.3f pixels" % \
                                                              separation / self.cellsize
    ...
    def test_predict_vp(self):
        self.actualSetUp(zerow=True, block=True, rmax=2400.0, scale=0.5)
