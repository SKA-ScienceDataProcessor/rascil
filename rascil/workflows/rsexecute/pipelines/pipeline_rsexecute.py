...
from rascil.workflows.rsexecute.imaging.imaging_rsexecute import invert_list_rsexecute_workflow, residual_list_rsexecute_workflow, \
...
def ical_list_rsexecute_workflow(vis_list, model_imagelist, context, vis_slices=1, facets=1,
    ...
    if do_selfcal:
        ...
        predicted_model_vislist = predict_list_rsexecute_workflow(model_vislist, model_imagelist,
                                                                   ...
                                                                   facets=facets,
                                                                   gcfcf=gcfcf, **kwargs)
        cal_vis_list, gt_list = calibrate_list_rsexecute_workflow(cal_vis_list, predicted_model_vislist,
