...
def create_griddata_from_image(im, vis, nw=1, wstep=1e15, grid_reference=1.0):
    """ Create a GridData from an image

    :param reference: Reference point pixel usually 0.0 or 0.5
    :param vis:
    :param im: Image
    ...
    grid_wcs.wcs.crpix[0] = im.shape[3] // 2 + grid_reference
    grid_wcs.wcs.crpix[1] = im.shape[2] // 2 + grid_reference
