...
__all__ = ['create_pswf_convolutionfunction', 'create_awterm_convolutionfunction', 'convert_kernel_to_list']
...
def create_pswf_convolutionfunction(im, oversampling=128, support=6):
    ...
    :param support: Support in pixels
